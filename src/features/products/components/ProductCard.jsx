...
const ProductCard = ({ product }) => {
  return (
    <Link
      ...
      className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden flex flex-col h-full border border-gray-100"
    >
      {/* 1. Hiển thị ảnh sản phẩm thật từ URL */}
      <div className="aspect-square w-full overflow-hidden bg-gray-50">
        <img
          src={product.image_url || "https://via.placeholder.com/300"} // Fallback nếu chưa có ảnh
          alt={product.title}
      ...
      <div className="p-3 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex items-center justify-between">
          <div className="flex items-center bg-gray-100 px-1.5 py-0.5 rounded text-[10px] font-medium text-gray-600">
            <span className="mr-0.5">{product.rating || 0}</span>
